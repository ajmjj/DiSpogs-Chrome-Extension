function getReleaseData (songDataArr) {
  const releaseTitle = document.getElementsByClassName('title_1q3xW').item(0).innerText
  const artistName = document.getElementsByClassName('link_15cpV').item(0).innerText
  const albumName = releaseTitle.replace(`${artistName} -`, '').trim()
